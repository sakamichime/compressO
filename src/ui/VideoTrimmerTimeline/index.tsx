              ...
              <PopoverContent>
                <div className="p-2">
                  <p className="text-md mb-1">
                    {t('timeline.timelineControls')}
                  </p>
                  <p className="text-xs">
                    {t('timeline.clickToSelectTrack')}
                  </p>
                  <p className="text-xs">
                    {t('timeline.doubleClickToSplit')}
                  </p>
                  <p className="text-xs">
                    {t('timeline.doubleClickToAddTrack')}
                  </p>
                  <p className="text-xs">
                    {t('timeline.selectAndDeleteToDelete')}
                  </p>
                  <Button
                    size="sm"
                    fullWidth
