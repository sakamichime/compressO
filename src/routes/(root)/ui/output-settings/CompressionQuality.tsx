      ...
      <AnimatePresence mode="wait">
        {shouldEnableQuality ? (
          <motion.div {...slideDownTransition}>
            <Slider
              label
              aria-label={t('outputSettings.quality')}
              marks={[
                {
                  value: 0,
                  label: t('outputSettings.qualityLow'),
                },
                {
                  value: 50,
                  label: t('outputSettings.qualityMedium'),
                },
                {
                  value: 99,
                  label: t('outputSettings.qualityHigh'),
                },
              ]}
              ...
              getValue={(value) => {
                ...
                return val < 50
                  ? t('outputSettings.qualityLow')
                  : val >= 50 && val < 100
                    ? t('outputSettings.qualityMedium')
                    : t('outputSettings.qualityHigh')
              }}
              renderValue={(props) => (
