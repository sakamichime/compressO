        ...
        {shouldEnableCustomThumbnail ? (
          <motion.div {...slideDownTransition} className="mt-2">
            <TextInput
              type="text"
              label=""
              placeholder={t('outputSettings.noThumbnailSelected')}
              value={thumbnailFileName ?? t('outputSettings.noThumbnailSelected')}
            ...
            <div>
              ...
              {convertToExtension === 'webm' ? (
                <p className="text-xs italic text-danger-300 mt-2">
                  {t('outputSettings.webmNoThumbnail')}
                </p>
              ) : null}
            </div>
          </motion.div>
