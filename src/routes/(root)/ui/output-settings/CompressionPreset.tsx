...
function CompressionPreset({ videoIndex }: CompressionPresetProps) {
  ...
  const PRESETS: {
    ...
    {
      name: 'ironclad',
      description: <p>{t('outputSettings.ironcladDesc')}</p>,
    },
    {
      name: 'thunderbolt',
      description: <p>{t('outputSettings.thunderboltDesc')}</p>,
    },
  ]
        ...
        {!shouldDisableCompression ? (
          <motion.div {...slideDownTransition} className="mt-2">
            <div className="mt-8">
              <Select
                fullWidth
                label={t('outputSettings.compressionPreset')}
                  ...
                  <SelectItem
                    ...
                    endContent={
                      preset.name === compressionPresets.ironclad ? (
                        <Tooltip content={t('common.recommended')} aria-label={t('common.recommended')}>
                          <Icon
                            name="star"
