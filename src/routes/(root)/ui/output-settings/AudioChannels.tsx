      ...
      <AnimatePresence mode="wait">
        {shouldEnableCustomChannel ? (
          <motion.div {...slideDownTransition}>
            ...
            >
              <SelectItem key="mono" textValue={t('outputSettings.mono')}>
                {t('outputSettings.mono')}
              </SelectItem>
              <SelectItem key="stereo" textValue={t('outputSettings.stereo')}>
                {t('outputSettings.stereo')}
              </SelectItem>
            </Select>
            <AnimatePresence mode="wait">
              {audioConfig?.audioChannelConfig?.channelLayout === 'mono' ? (
                <motion.div {...slideDownTransition} className="mt-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    >
                      <span className="text-sm">{t('outputSettings.left')}</span>
                    </Checkbox>
                    ...
                    <Checkbox
                      ...
                      isDisabled={shouldDisableInput}
                    >
                      <span className="text-sm">{t('outputSettings.right')}</span>
                    </Checkbox>
                  </div>
                </motion.div>
              ) : null}
                ...
                <motion.div {...slideDownTransition} className="mt-4">
                  ...
                  >
                    <p className="text-gray-600 dark:text-gray-400 text-sm mr-2 w-full">
                      {t('outputSettings.swapLeftRightChannels')}
                    </p>
                  </Switch>
                </motion.div>
              ) : null}
