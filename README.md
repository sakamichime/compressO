...
[**English**](README.md) | [**中文**](docs/README_zh.md) | [**日本語**](docs/README_ja.md) | [**한국어**](docs/README_ko.md)
...
- 🎬 **Video Compression** - Compress any video into a tiny size with high quality
- 🌍 **Multi-language Support** - Available in 11 languages: English, 中文, 日本語, 한국어, Español, Français, Deutsch, Русский, Português, Tiếng Việt, Bahasa Indonesia
- 🚀 **GPU Acceleration** - Hardware-accelerated encoding support for NVIDIA (NVENC), AMD (AMF), and Intel (QSV) GPUs
- ✂️ **Trim & Split** - Trim and split videos with visual timeline editor
- 📦 **Batch Compression** - Compress multiple videos at once
- 🎨 **Video Transformation** - Rotate, flip, and crop videos
- 🔊 **Audio Configuration** - Adjust volume, bitrate, channels, and codec
- 📝 **Subtitle Embedding** - Embed subtitles into videos
- 🏷️ **Metadata Editing** - Edit video metadata (title, artist, year, etc.)
- 🖼️ **Custom Thumbnail** - Set custom thumbnail for videos
- 🔒 **Privacy First** - Works completely offline, no network requests
